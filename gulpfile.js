...
gulp.task('compile', function() {
    ...
    tsResult.dts
        ...
        .pipe(concat('awayjs-player.d.ts'))
...
gulp.task('package', ['compile'], function(callback){
    ...
    glob('./lib/**/*.js', {}, function (error, files) {
        ...
        b.bundle()
            .pipe(exorcist('./build/awayjs-player.js.map'))
            .pipe(source('awayjs-player.js'))
            .pipe(gulp.dest('./build'))
            .on('end', callback);
    });
});
...
gulp.task('package-min', ['package'], function(callback){
    return gulp.src('./build/awayjs-player.js')
        ...
        .pipe(transform(function() {
            return exorcist('./build/awayjs-player.min.js.map');
        }))
        .pipe(gulp.dest('./build'));
});
